Scriptname SimpleSettlementSolutions:Picker:Handler extends Quest

ReferenceAlias Property PickerAlias Auto Const Mandatory

SimpleSettlementSolutions:Picker Function getPicker()
	return PickerAlias.GetActorReference() as SimpleSettlementSolutions:Picker
EndFunction
